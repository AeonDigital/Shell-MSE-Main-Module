...
MSE_FUNCTION_MAN["description"]="Converts a \"decimal\" to its respective \"octal\"."
...
MSE_FUNCTION_MAN["return.description"]+="\"Octal\" representation of the reported \"decimal\"."
