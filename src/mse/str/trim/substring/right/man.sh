...
MSE_FUNCTION_MAN["description"]="Eliminates any existing white space immediately AFTER the indicated substring."
...
MSE_FUNCTION_MAN["example.0"]+="mse_str_trim_substring_right \",\" \"Keep calm   ,   and...\"\n"
