...
test_mse_file_write() {
  ...
  #
  # REPLACE - ERROR 01
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r")
  ...
  #
  # REPLACE - ERROR 02
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "invalidfunction")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 03
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "mse_str_trim")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 04
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "3000")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 06
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "2 4 6")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 07
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "a 4")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 08
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "2 b")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
  ...
  #
  # REPLACE - ERROR 09
  rawResult=$(mse_file_write "${expectedDir}/test_mse_file_write_result" "ContentArrayName" "r" "2 1")
  testResult="${rawResult%%[![:graph:]]*}"
  testExpected="0"
