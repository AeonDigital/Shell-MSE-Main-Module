...
mse_conf_mainSetVariable()
{
  ...
  mseParamRules["param_3"]="VariableValue :: r :: string"
  mseParamRules["param_4"]="Operation :: r :: list"
  mseParamRules["param_4_labels"]="add, remove, change, comment, uncomment"
  mseParamRules["param_4_values"]="a, r, ch, c, u"
  mseParamRules["param_5"]="CommentChar :: r :: char"
  mseParamRules["param_6"]="Position :: o :: list"
