...
MSE_FUNCTION_MAN["description"]="Converts a \"char\" to its respective \"decimal\"."
...
MSE_FUNCTION_MAN["return.type"]="charDecimal"
MSE_FUNCTION_MAN["return.description"]=""
MSE_FUNCTION_MAN["return.description"]+="\"Decimal\" representation of the reported \"char\".\n"
...
MSE_FUNCTION_MAN["example.0"]+="mse_str_convert_char_to_decimal \"í\"\n"
MSE_FUNCTION_MAN["example.0"]+="\"195 173\""