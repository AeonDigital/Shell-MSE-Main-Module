...
MSE_FUNCTION_MAN["description"]="Converts a \"decimal\" to its respective \"char\"."
...
MSE_FUNCTION_MAN["return.type"]="char"
MSE_FUNCTION_MAN["return.description"]=""
MSE_FUNCTION_MAN["return.description"]+="\"Char\" representation of the reported \"decimal\"."
...
MSE_FUNCTION_MAN["example.0"]+="mse_str_convert_decimal_to_char \"195 173\"\n"
MSE_FUNCTION_MAN["example.0"]+="\"í\""