...
MSE_FUNCTION_MAN["description"]="Converts a \"hex\" to its respective \"decimal\"."
...
MSE_FUNCTION_MAN["return.description"]+="\"Decimal\" representation of the reported \"hexadecimal\"."
