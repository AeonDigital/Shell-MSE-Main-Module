...
MSE_FUNCTION_MAN["description"]="Identifies when the passed named variable is an associative array."


MSE_FUNCTION_MAN["param.1.type"]="string"
MSE_FUNCTION_MAN["param.1.name"]="VarName"
...
MSE_FUNCTION_MAN["param.1.description"]="Name of the variable to be tested."
