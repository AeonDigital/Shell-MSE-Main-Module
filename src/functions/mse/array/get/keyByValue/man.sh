...
MSE_FUNCTION_MAN["description"]="Identifies the key corresponding to the value passed in the indicated associative array."
...
MSE_FUNCTION_MAN["param.2.description"]="Name of the associative array where the search is to be made."
...
MSE_FUNCTION_MAN["return.description"]+="Returns the key on the associative array that corresponds to the indicated value.\n"
