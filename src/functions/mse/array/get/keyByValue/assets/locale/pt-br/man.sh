...
MSE_FUNCTION_MAN["description"]="Identifica o índice correspondente ao valor passado no array associativo indicado."


MSE_FUNCTION_MAN["param.1.description"]="Valor que está sendo pesquisado."

MSE_FUNCTION_MAN["param.2.description"]="Nome do array associativo onde a pesquisa deve ser feita."
...
MSE_FUNCTION_MAN["return.description"]+="Retorna a chave no array associativo que corresponde ao valor indicado.\n"
