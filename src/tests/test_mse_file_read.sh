...
test_mse_file_read() {
  ...
  testExpected="$(< "src/tests/samples/test_mse_file_read_raw_0_0")"

  mse_utest_assertEqual


  testResult=$(mse_file_read "src/tests/samples/test_mse_file_read_raw" "1")
  testExpected="$(< "src/tests/samples/test_mse_file_read_raw_1_0")"

  mse_utest_assertEqual


  testResult=$(mse_file_read "src/tests/samples/test_mse_file_read_raw" "1" "1")
  testExpected="$(< "src/tests/samples/test_mse_file_read_raw_1_1")"
