...
test_mse_exec_validateParams() {
  ...
  #
  pData=("src/tests/00_assets/expected/validateParams/mse_exec_validateParams_fileName")
  ...
  # FAIL : File not exist
  pData=("src/tests/00_assets/expected/validateParams/mse_exec_validateParams_nonexist")
  pRules["param_0"]="P1 :: 1 :: fileName"
  ...
  if [ -f "src/tests/00_assets/expected/validateParams/mse_exec_validateParams_created" ]; then
    rm "src/tests/00_assets/expected/validateParams/mse_exec_validateParams_created"
  fi
  pData=("src/tests/00_assets/expected/validateParams/mse_exec_validateParams_created")
  ...
  testResult=$([ -f "src/tests/00_assets/expected/validateParams/mse_exec_validateParams_created" ] && echo "1")
  testExpected="1"
  ...
  #
  pData=("src/tests/00_assets/expected/validateParams/dirName")
  ...
  pData=("src/tests/00_assets/expected/validateParams/nonexist")
  pRules["param_0"]="P1 :: 1 :: dirName"
  ...
  if [ -d "src/tests/00_assets/expected/validateParams/created" ]; then
    rm -rf "src/tests/00_assets/expected/validateParams/created"
  fi
  pData=("src/tests/00_assets/expected/validateParams/created")
  ...
  testResult=$([ -d "src/tests/00_assets/expected/validateParams/created" ] && echo "1")
  testExpected="1"
